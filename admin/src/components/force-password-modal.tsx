...
/**
 * Blocking first-login screen for the super-admin. The platform bootstrap seeds
 * the account with `mustChangePassword=true`, and the API locks every endpoint
 * except change-password until it's rotated — this is the UX half of that. It
 * can't be dismissed (no backdrop close, no X).
 */
const WHY = [
  'Първоначалната парола идва от настройката на сървъра — може да е била виждана при инсталацията.',
  'Супер-админ управлява всички ферми; това е най-чувствителният достъп в системата.',
