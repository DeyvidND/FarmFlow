    ...
    extend: {
      colors: {
        ...
        ff: {
          ...
          red: 'var(--ff-red)',
          'red-soft': 'var(--ff-red-soft)',
          'green-on': 'var(--ff-green-on)',
          demo: 'var(--ff-demo)',
          'demo-soft': 'var(--ff-demo-soft)',
          overlay: 'var(--ff-overlay)',
          'toggle-off': 'var(--ff-toggle-off)',
          'sidebar-bg': 'var(--ff-sidebar-bg)',
          'sidebar-hover': 'var(--ff-sidebar-hover)',
          'sidebar-active': 'var(--ff-sidebar-active)',
          'sidebar-ink': 'var(--ff-sidebar-ink)',
          'sidebar-muted': 'var(--ff-sidebar-muted)',
          'sidebar-border': 'var(--ff-sidebar-border)',
        },
      },
      fontFamily: {
