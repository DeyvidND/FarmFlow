      ...
      <div className="mt-5">
        <HelpTabs
          guide={
            ...
            <Section id="overview" icon={Truck} tone="bg-ff-green-50 text-ff-green-700" title="Как работи доставката"
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  { icon: FileSpreadsheet, t: 'Качи пратки', d: 'Качваш Excel/CSV, поправяш редовете, избираш най-евтиния куриер и създаваш пратките.' },
            ...
            <Section id="import" icon={FileSpreadsheet} tone="bg-ff-green-50 text-ff-green-700" title="Внос на пратки"
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  { icon: Scale, t: '4 · Потвърди', d: '„Потвърди поръчки" сравнява Еконт и Спиди за цялата партида и предлага по-евтиния — цялата партида тръгва с ЕДИН куриер.' },
                ].map((x) => (
              ...
              <div className="mt-4 grid items-start gap-4 lg:grid-cols-2">
                <Callout tone="tip" title="Цените идват от куриерите">„Потвърди поръчки" пита Econt и Speedy за цена на цялата партида и показва двете общи суми. По-евтиният е предварително избран (значка „Най-евтино") — може да превключиш на другия с клик върху картата му, преди да натиснеш „Изпрати".</Callout>
            ...
            {/* ---------------------------------------------------------------- */}
            <Section id="rechnik" icon={Info} tone="bg-ff-green-50 text-ff-green-700" title="Речник — какво значат думите">
              <div className="grid gap-2.5 sm:grid-cols-2">
                {[
                  ['Товарителница', 'Стикерът/документът, който куриерът лепи на пратката — с адрес, телефон и баркод за проследяване.'],
                  ['Наложен платеж', 'Клиентът плаща в брой при получаване — на куриера или на гишето. Парите се връщат при теб по-късно.'],
                  ['Обявена стойност', 'Сума, за която застраховаш пратката — обезщетение до тази сума при загуба/повреда.'],
                  ['Обратна разписка (Speedy)', 'Клиентът подписва при получаване и разписката се връща при теб — доказателство за доставка.'],
                  ['Чернова', 'Поръчка от магазина, чакаща да стане истинска товарителница — избираш куриер и я потвърждаваш.'],
                  ['Среда (Демо / Реална)', 'Демо е тестова връзка — нищо не се праща истински. Реална създава истински пратки.'],
                  ['Партида', 'Група пратки, качени наведнъж от един Excel файл и потвърдени заедно.'],
                ].map(([t, d]) => (
                  <div key={t} className="rounded-xl border border-ff-border bg-ff-surface-2 p-3.5">
                    <div className="text-[13px] font-bold text-ff-ink">„{t}“</div>
                    <div className="mt-0.5 text-[12.5px] leading-snug text-ff-muted">{d}</div>
                  </div>
                ))}
              </div>
            </Section>
