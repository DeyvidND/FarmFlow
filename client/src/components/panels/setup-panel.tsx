...
const CARD_COPY =
  'Клиентът плаща веднага с карта, през защитена страница — като ПОС терминал, но онлайн. Парите се обработват от Stripe (сигурна услуга за картови плащания) и влизат по твоята сметка. Свързва се еднократно от „Плащания“.';
...
export function SetupPanel({
  ...
  const cardDesc = stripeAvailable
    ? stripeReady
      ...
      : 'Свържи картовите плащания (Stripe) в „Плащания“, за да приемаш плащане с карта.'
    : CARD_COPY;
