...
export function WazeStepper({
  ...
  return (
    ...
    >
      <div
        className="animate-ff-pop w-[420px] max-w-full rounded-2xl border border-ff-border bg-ff-surface p-5 shadow-ff-lg"
        ...
        {done ? (
          ...
          <>
            ...
            <p className="mt-2.5 text-[12px] text-ff-muted">
              Waze тръгва от текущото ти място до тази спирка. След доставка цъкни «Следваща» или
              бутона за навигация към следващата. Точките горе показват напредъка — цъкни на коя да е,
              за да скочиш направо до нея.
            </p>
          </>
        )}
      </div>
