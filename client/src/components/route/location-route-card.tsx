...
export function LocationRouteCard({
  ...
  return (
    ...
    >
      <div
        className="animate-ff-pop max-h-[90vh] w-[460px] max-w-full overflow-y-auto overscroll-contain rounded-2xl border border-ff-border bg-ff-surface p-6 shadow-ff-lg"
