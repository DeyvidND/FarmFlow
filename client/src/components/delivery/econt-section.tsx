      ...
      <div className="flex flex-col gap-[18px]">
        ...
        <div>
          ...
          <p className={subDescCls}>
            <b>Ръчно</b> — клиентът дава адреса си, ти пускаш пратката до този адрес от своя офис на
            Еконт (Еконт сам определя най-близкия офис до клиента). Всяка сутрин получаваш списък по
            имейл какво да изпратиш. <b>Автоматично</b> — свързваш Еконт акаунт и системата прави
        ...
        <div className="flex items-start gap-2.5 rounded-[10px] border border-ff-border-2 bg-ff-surface-2 px-3.5 py-3 text-[13px] text-ff-ink-2">
          ...
          <span>
            ...
            си вземе поръчката? Можеш да пропуснеш Еконт.
          </span>
        </div>
