...
export function AdminShell({
  ...
  role?: string;
  /** Set when this session is a super-admin "full-panel impersonation" of this
   *  tenant — shows the persistent warning banner above the whole shell. */
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      {actingAdminId && <ImpersonationBanner tenantName={tenantName} />}
