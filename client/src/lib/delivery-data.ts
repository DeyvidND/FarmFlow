...
> = {
  ...
  ownSlots: { name: 'Лична доставка', econt: false, desc: 'Ти доставяш сам в час, избран от клиента — не минава през Еконт.' },
...
export const SLOTS_HELP = {
  ...
  steps: [
    { title: 'Включи доставката', body: 'Превключвателят „Лична доставка + часове“ трябва да е включен, за да се показват часовете в магазина (управлява се от страница „Методи и цени“).' },
  ...
  tips: [
    ...
    'Сгрешил час? Клик върху часа го маха; редактирай го с молива, ако само интервалът е грешен.',
