...
export const SLOTS_HELP = {
  ...
  steps: [
    ...
    { title: 'Добави часове (слотове)', body: 'Натисни „+ Слот“ под някой ден и задай интервал (напр. 10:00–11:00) и капацитет — колко поръчки поемаш за този час.' },
  ...
  tips: [
    ...
    'Капацитетът на слота е твоята защита — спира приема, щом часът се напълни.',
    ...
    'В правилото избираш само дните, в които доставяш. Изключи „Еднакви часове за всички дни“, за да дадеш на всеки ден собствени часове и капацитет (напр. Пн 10–12, Ср 16–18, Сб — не).',
  ],
};
