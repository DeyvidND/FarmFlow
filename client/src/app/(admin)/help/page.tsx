...
const SECTIONS: Section[] = [
  ...
  },
  {
    id: 'plashtania',
    title: 'Плащания',
    lead: 'Абонаментът ти за FarmFlow и приемането на плащания с карта от клиенти.',
    bullets: [
      'Абонамент: 30 € на месец + 2 € на изпратен бюлетин, таксува се автоматично.',
      '„Добави карта“ — сигурно плащане през Stripe; „Управление“ отваря портала за смяна на картата и фактури.',
      'Статус: Активен / Просрочен (с брояч до спиране) / Спрян. При неуспешно плащане обнови картата.',
      'Премиум фермите са безплатни — без месечна такса и без такса за бюлетини.',
      'Приемане на плащания с карта: свържи Stripe и клиентите плащат онлайн; парите идват директно при теб. 0% комисиона върху поръчките.',
    ],
    shots: [],
  },
  {
    ...
    bullets: [
      ...
      'Стъпка 2 — избери „физическо лице“ или „фирма“ и попълни име, адрес и дата на раждане.',
