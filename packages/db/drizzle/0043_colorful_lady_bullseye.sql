...
CREATE INDEX "paw_product_range_idx" ON "product_availability_windows" USING btree ("product_id","starts_at","ends_at");--> statement-breakpoint
CREATE INDEX "paw_tenant_idx" ON "product_availability_windows" USING btree ("tenant_id");