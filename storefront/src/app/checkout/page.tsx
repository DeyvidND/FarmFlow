...
/**
 * Storefront checkout — React port of `checkout.html`, wired to the public API
 * (replaces the temporary S5 slot-picker harness). Contact + delivery method +
 * the live <SlotPicker> + order summary. Submitting posts to `/checkout`: with
 * Stripe it redirects to the hosted page; for a cash farm it lands on the
 * confirmation page. The template's fake card form is gone.
 */
        ...
        <div className="wrap">
          ...
          <form className="commerce-grid" onSubmit={submit}>
            <div className="stack" style={{ gap: 26 }}>
              ...
              {/* delivery slot — hidden when the farm offers no slots */}
              {hasSlots !== false && (
                <div className="card" style={{ padding: 24, boxShadow: 'none' }}>
